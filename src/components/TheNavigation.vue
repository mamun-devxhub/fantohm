...
<template>
      ...
      <li class="nav-link">
        ...
        <div>
          ...
          <ul class="py-3">
            <li>
              <router-link
                class="text-secondary text-[10.5px] font-semibold hover:text-text-hover active:text-text-hover"
                to="/staking"
                >Staking</router-link
              >
            </li>
  ...
  <!-- Nav Button -->
  <button
    class="z-50 relative top-4 left-3 w-10 h-10 text-gray-500 focus:outline-none lg:hidden"
