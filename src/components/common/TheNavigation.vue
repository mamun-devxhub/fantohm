...
<template>
  ...
  >
    ...
    <ul>
      ...
      <li
        class="flex items-start text-primary py-2 text-[14.5px] font-normal hover:text-text-hover-color active:text-text-hover-color"
      >
        ...
        <div>
          ...
          <ul class="py-3">
            <li>
              <router-link
                class="text-secondary text-[10.5px] font-semibold hover:text-text-hover-color active:text-text-hover-color"
                to="/staking"
                >Staking</router-link
              >
            </li>
    ...
    >
      <a href="#">
        <img
          class="mr-3 hover:scale-110"
          src="../../assets/icon/navbar/13.svg"
          alt=""
        />
      </a>
      <a href="#">
  ...
  <nav class=" fixed top-0 left-0 no-scrollbar overflow-y-auto h-full">
    <transition name="slide">
      <ul
        v-if="toggleMenu"
        class="box-shadow background shadow-lg pt-14 pb-24 px-10 relative left-0 z-30 w-fit transition-all duration-200 ease-linear"
      >
        <!-- <div class="fixed top-0 bottom-0 right-0 left-0 flex justify-center backdrop-blur-lg bg-[rgba(60,67,78, 0.4)] -z-50 transition-all duration-300 ease-linear"></div> -->
        <div class="py-10 w-28">
          <img src="../../assets/icon/navbar/logo.svg" alt="" />
        </div>
        ...
        >
          <a href="#">
            <img
              class="mr-3 hover:bg-text-hover-color hover:scale-110"
              src="../../assets/icon/navbar/13.svg"
              alt=""
            />
          </a>
